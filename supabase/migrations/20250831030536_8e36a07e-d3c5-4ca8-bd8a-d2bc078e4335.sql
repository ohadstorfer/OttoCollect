...
SELECT 
  ...
  bt.country_tr, bt.face_value_tr, bt.islamic_year_tr, bt.signatures_front_tr, bt.signatures_back_tr,
  bt.seal_names_tr, bt.sultan_name_tr, bt.printer_tr, bt.type_tr, bt.category_tr,
  bt.security_element_tr, bt.colors_tr, bt.banknote_description_tr, bt.historical_description_tr, bt.dimensions_tr,
  bt.country_ar, bt.face_value_ar, bt.islamic_year_ar, bt.signatures_front_ar, bt.signatures_back_ar,
  bt.seal_names_ar, bt.sultan_name_ar, bt.printer_ar, bt.type_ar, bt.category_ar,
  bt.security_element_ar, bt.colors_ar, bt.banknote_description_ar, bt.historical_description_ar, bt.dimensions_ar
...
SELECT 
  ...
  CASE 
    WHEN bt.banknote_description_ar IS NOT NULL THEN bt.banknote_description_ar 
    ELSE ub.banknote_description 
  END as banknote_description_translated,
  -- All translation fields
  bt.name_tr, bt.country_tr, bt.face_value_tr, bt.banknote_description_tr,
  bt.name_ar, bt.country_ar, bt.face_value_ar, bt.banknote_description_ar

...
-- Recreate the enhanced_detailed_banknotes view to ensure it exists
...
SELECT 
  ...
  -- Resolve signatures_front URLs (NEW - replaces signature_pictures_urls)
  CASE 
  ...
  -- Resolve signatures_back URLs (NEW - replaces signature_pictures_urls)
  CASE 

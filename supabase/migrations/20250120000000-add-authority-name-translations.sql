-- Add authority_name_ar and authority_name_tr columns to banknotes_translation table
ALTER TABLE public.banknotes_translation 
ADD COLUMN IF NOT EXISTS authority_name_ar TEXT,
ADD COLUMN IF NOT EXISTS authority_name_tr TEXT;

-- Add authority_name_ar and authority_name_tr fields to enhanced_banknotes_with_translations view
...
SELECT 
  ...
  bt.dimensions_ar,
  -- Authority name translations - NEW FIELDS
  CASE 
    WHEN bt.authority_name_ar IS NOT NULL THEN bt.authority_name_ar 
    ELSE db.authority_name 
  END as authority_name_ar,
  CASE 
    WHEN bt.authority_name_tr IS NOT NULL THEN bt.authority_name_tr 
    ELSE db.authority_name 
  END as authority_name_tr

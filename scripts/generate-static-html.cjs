...
const routes = [
  ...
  { path: '/catalog/Turkish%20Republic', canonical: 'https://ottocollect.com/catalog/Turkish%20Republic' },
  { path: '/catalog/Palestine%20Mandate', canonical: 'https://ottocollect.com/catalog/Palestine%20Mandate' },

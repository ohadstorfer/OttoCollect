      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardContent className="p-8 prose prose-gray max-w-none">
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4"><span>Collection of information</span></h2>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3"><span>Database</span></h3>
            <p className="mb-3">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3"><span>Server logs</span></h3>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4"><span>Use of information</span></h2>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3"><span>Forums</span></h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3"><span>Customer Service</span></h3>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4"><span>Choice/Opt-out</span></h2>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3"><span>Analytics</span></h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3"><span>Integrated Payment Methods</span></h3>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4"><span>Links to Other Sites</span></h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4"><span>Tell Your Friends</span></h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4"><span>Security</span></h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4"><span>You're in charge of your data</span></h2>
            
            <h3 className="text-xl font-semibold mt-6 mb-3"><span>Accessing and changing your data</span></h3>
            <p className="mb-4">

  ...
  const renderImages = () => {
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
        <div className="relative aspect-[3/2] bg-background border rounded-md overflow-hidden">
          <BanknoteImage 
            imageUrl={banknoteData?.imageUrls?.[0] || null} 
            alt={`${banknoteData?.denomination} front`}
        ...
        <div className="relative aspect-[3/2] bg-background border rounded-md overflow-hidden">
          <BanknoteImage 
            ...
            alt={`${banknoteData?.denomination} back`}
            className="object-contain w-full h-full"
          />
        </div>
      </div>

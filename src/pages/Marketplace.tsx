    ...
    <div className="min-h-screen animate-fade-in">
          ...
          <div className="mt-8 max-w-2xl mx-auto reveal fade-bottom">
            <div className="relative">
              <Input
                ...
                className="ottoman-input pr-10 bg-white/10 text-white placeholder:text-gray-400"
                value={searchTerm}
      ...
      <section className="py-8">
        <div className="container mx-auto px-4">
          {/* Filter section */}
          <Card className="mb-8 bg-dark-600/50 border-ottoman-900/30">
            <div className="p-4">
          ...
          {loading ? (
            <div className="flex flex-col items-center justify-center py-20 space-y-4">
              <Spinner size="lg" />
              <p className="text-ottoman-300">Loading marketplace items...</p>
            </div>
          ) : error ? (
            ...
            <Card className="text-center py-20 bg-dark-600/50 border-ottoman-900/30">
              ...
              <div className="space-x-4">
                <Button 
                  variant="outline" 
                  className="border-ottoman-700 text-ottoman-200"
                  onClick={resetFilters}
                >
                  Clear All Filters
                </Button>
